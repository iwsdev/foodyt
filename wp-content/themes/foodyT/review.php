        ...
        <table>
            <tbody>
                ...
                <tr style="margin-top: 50px">
                    <td>You will pay €<?= $_SESSION["Payment_Amount"] ?> on the first day of every month.</td>
                </tr>
            <tbody>
        </table>
        <form action='http://cmsbox.in/wordpress/foodyTv2/order-confirm/' METHOD='POST'>
            <input type="submit" value="Review" class="pull-right"/>
        </form>
    </div>
</section>
<?php
