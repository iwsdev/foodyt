               ...
               <script>
	              ...
	              <div class='row desk'>
		              <div class='col-sm-12' id='dishCount'>
		              	    ...
		              	    <div class='padding10 hd-heading'><?= $_SESSION['lan']['dishname']?></div>
		              		<?php 
                      ...
                      foreach($totalDish as $dish){
			                ...
			                <div class='col-sm-2 visitor'>
			              		<div class='padding10 hd-heading'><?= $_SESSION['lan']['Visitor']?></div>
			              		<?php foreach($totalDish as $dish){
		              			echo "<p>".$dish->numberOfView."</p>";
		              		}
		              		?>
			                </div>
			            ...
			            <div class='col-sm-12' id="dishRating" style="display:none;">
			                ...
			                <div class='col-sm-2 visitor'>
			              		<div class='padding10'><?= $_SESSION['lan']['Valuations']?></div>
			              		<?php foreach($totalRating as $dish){
