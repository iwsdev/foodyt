										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													<a class="button button-primary" href="https://www.wponlinesupport.com/plugins-documentation/document-wp-blog-and-widgets/?utm_source=hp&event=doc" target="_blank"><?php _e('Documentation', 'wp-blog-and-widgets'); ?></a>									
													<a class="button button-primary" href="http://demo.wponlinesupport.com/blog-demo/?utm_source=hp&event=demo" target="_blank"><?php _e('Demo for Designs', 'wp-blog-and-widgets'); ?></a>
												</td>
											</tr>
										</tbody>
									</table>
							...
							<div class="postbox" style="">
								...
								<div class="inside">										
									<ul class="wpos-list">
										...
										<li>3 shortcodes</li>
										<li>Recent Blog Slider</li>
										<li>Recent Blog Carousel</li>
										<li>Recent Blog in Grid view</li>
										<li>Create a Blog Page OR Blog website</li>
									...
									<a class="button button-primary wpos-button-full" href="https://www.wponlinesupport.com/wp-plugin/wp-blog-and-widgets/?utm_source=hp&event=go_premium" target="_blank"><?php _e('Go Premium ', 'wp-blog-and-widgets'); ?></a>	
									<p><a class="button button-primary wpos-button-full" href="http://demo.wponlinesupport.com/prodemo/pro-blog-and-widgets-plugin-demo/?utm_source=hp&event=pro_demo" target="_blank"><?php _e('View PRO Demo ', 'wp-blog-and-widgets'); ?></a>			</p>								
								</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
					...
					<div class="metabox-holder">
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox">
									...
									<div class="inside">										
										<p>Enjoyed this plugin? You can help by rate this plugin <a href="https://wordpress.org/support/plugin/wp-blog-and-widgets/reviews/?filter=5" target="_blank">5 stars!</a></p>
									</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
